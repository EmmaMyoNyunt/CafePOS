...
public final class Week3Demo {
    public static void main(String[] args) {
        ...
        order2.addItem(new LineItem(catalog.findById("P-ESP").orElseThrow(), 1));
        order2.addItem(new LineItem(catalog.findById("P-CCK").orElseThrow(), 2));
        ...
        order3.addItem(new LineItem(catalog.findById("P-ESP").orElseThrow(), 3));
        System.out.println("Order #" + order3.id() + " Total: " + order3.totalWithTax(10));
        order3.pay(new WalletPayment("WALLET-XYZ-999"));
    }
}
